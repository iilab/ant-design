...
var Badge = function (_React$Component) {
    ...
    Badge.prototype.render = function render() {
        ...
        var _splitObject = (0, _splitObject4["default"])(this.props, ['count', 'prefixCls', 'overflowCount', 'className', 'style', 'children', 'dot', 'showZero', 'status', 'text']),
            ...
            showZero = _splitObject2$.showZero,
        ...
        // null undefined "" "0" 0
        var hidden = (!count || count === '0') && !isDot && !(showZero && (count === 0 || count === '0'));
...
Badge.propTypes = {
    ...
    showZero: _react2["default"].PropTypes.bool,
